...
const QuizResults = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 animate-fade-in">
      {/* Score Card */}
      <div className={`card-padded mb-8 text-center ${
        isPassing
        ...
        <div className="py-4">
          <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full mb-4 ${
            isPassing ? 'bg-primary-100' : 'bg-error-100'
          }`}>
            {isPassing ? (
          ...
          <div className={`text-5xl font-bold mb-2 tabular-nums ${isPassing ? 'text-primary-600' : 'text-error-600'}`}>
            {score.percentage}%
          </div>
          ...
          <p className={`mt-4 font-semibold ${isPassing ? 'text-primary-700' : 'text-error-700'}`}>
